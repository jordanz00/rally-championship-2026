...
import { SURFACES, COLORS, ROAD_DECK, LIGHTING, VISUAL, STREAM } from "../config.js?v=164";
  ...
  _addTunnelMountain(start, end, rock, rockDark) {
    ...
    for (let i = start; i <= end; i += 2) {
      ...
      for (const side of [-1, 1]) {
        ...
        // Sit the mass ON the ridge (gy), buried so toes never float.
        masses.push({
          c: chunk,
          x: hx,
