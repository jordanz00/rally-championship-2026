...
import { DESERT_DEFINITION } from "./stages/desert-definition.js?v=9";
import { FOREST_DEFINITION } from "./stages/forest-definition.js?v=9";
import { MOUNTAIN_DEFINITION } from "./stages/mountain-definition.js?v=8";
import { LAKESIDE_DEFINITION } from "./stages/lakeside-definition.js?v=6";
