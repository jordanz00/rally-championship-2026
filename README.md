...
Browser arcade rally inspired by classic Sega Rally immediacy — original stages, six-car garage, championship flow, cinema PBR lighting, co-driver calls, and power-slide handling.

## Play online

**https://jordanz00.github.io/rally-championship-2026/**

Hard refresh after updates: `Cmd+Shift+R` (Mac) or `Ctrl+Shift+R` (Windows). Add `?v=351` if assets look stale.
...
Open `http://127.0.0.1:8765/index.html?v=351`
